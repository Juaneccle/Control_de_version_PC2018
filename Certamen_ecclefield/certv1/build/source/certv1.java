...
// COLOR
int original1 = color(0xff5db5a4);
int original2 = color(0xfff57a82);
int original3 = color(0xffed5276);
...
int ef_c = color(240, 202, 77);     // color ellipse del fondo cambio
int f1_c = color(0);
int t1_c = color(0);
...
int f1 = color(cf1,cf2, cf3);       //(70,179,157);    // (63,43,55);
int t1 = color(ct1,ct2,ct3);         // 222,91,73           // (240,67,58);
